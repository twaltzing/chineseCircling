...
// set variables equal to actual values in sentences
    ...
    let arrShSub=['George','Obama','Abraham Lincoln','Karen','RinTinTin','Batman','蔣介石','Sponge Bob','Madam Curie','Harry Potter', 'Aristotle','Stifler\'s Mom'];
...
// ///////////////////////////////
// // MainVerb No w Shadow, ma // QUESTION 9
// //////////////////////////////
...
// add sentence to top of question array to make new array
        var storyElement =[];
        storyElement.push(sentence);
        storyElement.push(quesArr);
        console.log(storyElement);

        var myJSON = JSON.stringify(storyElement);
        document.getElementById("display").innerHTML = myJSON;


return(storyElement);

//establish variables to hold individual pieces
            //  var question1 = quesArr[0].question;
            //  var shortAns1 = quesArr[0].shortAnswer;
            //  var longAns1 = quesArr[0].longAnswer;
            //  var threefer1 = quesArr[0].threefer;
            //  var question2 = quesArr[1].question;
            //  var shortAns2 = quesArr[1].shortAnswer;
            //  var longAns2 = quesArr[1].longAnswer;
            //  var threefer2 = quesArr[1].threefer;
            //  var question3 = quesArr[2].question;
            //  var shortAns3 = quesArr[2].shortAnswer;
            //  var longAns3 = quesArr[2].longAnswer;
            //  var threefer3 = quesArr[2].threefer;
